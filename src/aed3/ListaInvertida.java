...
public class ListaInvertida {
  ...
  /**
   * Fecha os arquivos abertos (dicionario e blocos).
   * Acrescentado ao codigo do prof. para integrar com o ciclo de
   * vida do projeto (ArquivoCurso fecha todos os indices em sequencia).
   */
  public void close() throws Exception {
    if (arqDicionario != null) arqDicionario.close();
    if (arqBlocos != null)     arqBlocos.close();
  }
